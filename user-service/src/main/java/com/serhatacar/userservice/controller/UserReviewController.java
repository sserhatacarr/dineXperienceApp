...
public class UserReviewController {
    ...
    @Operation(summary = "Get user review by id", description = "Returns a user review by id <br>Accessible to admin users only.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create user review", description = "Creates a user review <br>Accessible to all users.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all user reviews", description = "Returns all user reviews <br>Accessible to admin users only.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "500", description = "Internal Server Error")
    })
    ...
    @Operation(summary = "Get user reviews by user id", description = "Returns user reviews by user id <br>Accessible to admin users only.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"),
    ...
    @Operation(summary = "Get user reviews by restaurant id", description = "Returns user reviews by restaurant id <br>Accessible to admin users only.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"),
    ...
    @Operation(summary = "Edit user review", description = "Edits a user review <br>Accessible to admin users only.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"),
    ...
    @Operation(summary = "Delete user review", description = "Deletes a user review <br>Accessible to admin users only.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Success"),
            @ApiResponse(responseCode = "400", description = "Bad Request<br>-User review not found"),
            @ApiResponse(responseCode = "500", description = "Internal Server Error")
